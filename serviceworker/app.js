// var API_KEY        = 'AAAAYrIBze8:APA91bG9VyFxQh29KmB-bDJfAcO6-dgWAxEWFdjJX4WOegDx4yGNRAfBD2UBimBjKJSJv5D30aktQ30bR2QI2MXEWt_p4qCklR7HXMmd_TC54kopomHx-rG7msGvbSW-H7dhSTAJXqiy';
// var SENDER_ID      = '423893257711';
...
function addZero(i) { return i > 9 ? i : '0' + i; }
...
if ('Notification' in window && 'serviceWorker' in navigator && 'localStorage' in window && 'fetch' in window && 'postMessage' in window) {
    ...
    bt_register.on('click', function() { getToken(); });
    ...
    messaging.requestPermission()
        .then(function() {
            ...
            messaging.getToken()
                ...
                .catch(function(error) {
                    showError('Error. Push Permission Required', error);
                    updateUIForPushPermissionRequired();
                    setTokenSentToServer(false);
                });
        })
